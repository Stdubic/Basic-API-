$(document).ready(function () {
    ...
    $(document).on('click', '.update-product-button', function () {
        ...
        $.getJSON("http://localhost:8000/product/read_one.php?id=" + id, function (data) {
            ...
            $.getJSON("http://localhost:8000/category/read.php", function (data) {
...
// chage page title
    ...
    $(document).on('submit', '#update-product-form', function () {
        ...
        $.ajax({
            url: "http://localhost:8000/product/update.php",
            type: "POST",
